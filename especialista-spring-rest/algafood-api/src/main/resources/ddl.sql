...
create table grupo_permisaao (grupo_id bigint not null, permissao_id bigint not null) engine=InnoDB
...
alter table grupo_permisaao add constraint FKtcilmixjqc3mdge0b4lfn7t08 foreign key (permissao_id) references permissao (id)
alter table grupo_permisaao add constraint FKb3vbynnnn65elhcnc8yi910tv foreign key (grupo_id) references grupo (id)
...
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro) values (1, 'Thai Gourmet', 10, 1, utc_timestamp, utc_timestamp, 1, '38400-999', 'Rua João Pinheiro', '1000', 'Centro')
